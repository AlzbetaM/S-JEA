...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           ...
           'wide_resnet50_2', 'wide_resnet101_2', 'projection_MLP', 'Sup_Head', 'Sup_Hyperbolic', 'alexnet', 'projection_pred', 'sprojection_pred', 'mprojection_pred']
...
class SmallAlexNet(nn.Module):
    def __init__(self,):
        ...
        # conv_block_4
        blocks.append(nn.Sequential(
            nn.Conv2d(384, 96, kernel_size=3, padding=1, bias=False),
            nn.BatchNorm2d(96),
            nn.ReLU(inplace=True),
        ))
...
class Sup_Head(nn.Module):
    ...
    def __init__(self, emb, n_classes):
