...
class Imagenet_DataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        dataset_train = ImageFolder(root=os.path.join(self.data_dir, 'train'), transform=transf)
    ...
    def val_dataloader(self):
        ...
        dataset_train = ImageFolder(root=os.path.join(self.data_dir, 'train'), transform=transf)
        dataset_valid = ImageFolder(root=os.path.join(self.data_dir, 'valid'), transform=transf)
        dataset_ssl = ImageFolder(root=os.path.join(self.data_dir, 'valid'), transform=transf_ssl)
    ...
    def test_dataloader(self):
        ...
        dataset_train = ImageFolder(root=os.path.join(self.data_dir, 'train'), transform=transf)
        dataset_test = ImageFolder(root=os.path.join(self.data_dir, 'valid'), transform=transf)
